...
try{ 
	...
	if (a.equals("C")){ // Get a record to display
		...
		// Open record
		String strsql = "SELECT * FROM recikel_zavezanci" + session.getAttribute("leto") + " WHERE 0 = 1";
		out.println(strsql);
		rs = stmt.executeQuery(strsql);
		rs.moveToInsertRow();
		...
		if (tmpfld == null) {
			...
			strsql = "SELECT * FROM recikel_zavezanci" + session.getAttribute("leto") + " WHERE st_pogodbe = '" + srchfld +"'";
...
<p><span class="jspmaker">Dodaj v: recikel zavezance<br><br><a href="recikelzavezancilist.jsp">Nazaj na pregled</a></span></p>
<script language="JavaScript" src="ew.js"></script>
<script language="JavaScript" src="popcalendar.js"></script>

<form onSubmit="return EW_checkMyForm(this);"  action="recikelzavezanciadd.jsp" method="post">
<p>
