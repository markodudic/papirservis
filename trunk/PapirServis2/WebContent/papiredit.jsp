...
<p><span class="jspmaker">Edit TABLE: papir<br><br><a href="papirlist.jsp">Back to List</a></span></p>
...
<form onSubmit="return EW_checkMyForm(this);"  name="papiredit" action="papiredit.jsp" method="post">
<p>
