...
if (searchwhere != null && searchwhere.length() > 0) {
	session.setAttribute("cenastr_searchwhere", searchwhere);
	startRec = 1; // Reset start record counter (new search)
	session.setAttribute("cenastr_REC", new Integer(startRec));
}else{
	if (session.getAttribute("cenastr_searchwhere") != null)
		searchwhere = (String) session.getAttribute("cenastr_searchwhere");
}
%>
<%
...
if (request.getParameter("cmd") != null && request.getParameter("cmd").length() > 0) {
	...
	if (cmd.toUpperCase().equals("RESET")) {
		...
		session.setAttribute("cenastr_searchwhere", searchwhere);
		session.removeAttribute("cenastr_OB");
		...
		searchwhere = ""; // Reset search criteria
		session.setAttribute("cenastr_searchwhere1", " cenastr.sif_kupca = zadnji.sif_kupca and cenastr.zacetek= zadnji.datum  and cenastr.material_koda = zadnji.material_koda ");
	}
...
if (OrderBy != null && OrderBy.length() > 0) {
	if (session.getAttribute("cenastr_OB") != null &&
		((String) session.getAttribute("cenastr_OB")).equals(OrderBy)) { // Check if an ASC/DESC toggle is required
		if (((String) session.getAttribute("cenastr_OT")).equals("ASC")) {
			session.setAttribute("cenastr_OT", "DESC");
		}else{
			session.setAttribute("cenastr_OT", "ASC");
		}
	}else{
		session.setAttribute("cenastr_OT", "ASC");
	}
	session.setAttribute("cenastr_OB", OrderBy);
	session.setAttribute("cenastr_REC", new Integer(1));
}else{
	OrderBy = (String) session.getAttribute("cenastr_OB");
	if (OrderBy == null || OrderBy.length() == 0) {
		OrderBy = DefaultOrder;
		session.setAttribute("cenastr_OB", OrderBy);
		session.setAttribute("cenastr_OT", DefaultOrderType);
	}
}

// Open Connection to the database
try{
String searchwhere1 = (String) session.getAttribute("cenastr_searchwhere1");
...
if (request.getParameter("start") != null && Integer.parseInt(request.getParameter("start")) > 0) {
	...
	if (IsNumeric(request.getParameter("pageno"))) {
		...
		startRec = ((Integer) session.getAttribute("cenastr_REC")).intValue();
		if (startRec <= 0) {
	...
	if (session.getAttribute("cenastr_REC") != null)
		startRec = ((Integer) session.getAttribute("cenastr_REC")).intValue();
	if (startRec==0) {
		startRec = 1; //Reset start record counter
		session.setAttribute("cenastr_REC", new Integer(startRec));
...
<table border="0" cellspacing="0" cellpadding="4">
	<tr>
		...
		&nbsp;&nbsp;<a href="cenastrlist.jsp?cmd=reset">Prikaži vse</a>
		</span></td>
		<td><span class="jspmaker">
		&nbsp;&nbsp;<a href="cenastrlist.jsp?cmd=top">Prikaži zadnje</a>
		</span></td>
	</tr>
...
<% if ((ewCurSec & ewAllowAdd) == ewAllowAdd) { %>
	<tr></tr>
	<tr><td><a href="cenastradd.jsp">Dodaj nov zapis</a></td></tr>
<% } %>
</table>
<form method="post">
<table class="ewTable">
...
<a href="cenastrlist.jsp?order=<%= java.net.URLEncoder.encode("sif_kupca","utf-8") %>">Šifra kupca (*)&nbsp;<% if (OrderBy != null && OrderBy.equals("sif_kupca")) { %><span class="ewTableOrderIndicator"><% if (((String) session.getAttribute("cenastr_OT")).equals("ASC")) { %>(^)<% }else if (((String) session.getAttribute("cenastr_OT")).equals("DESC")) { %>(v)<% } %></span><% } %></a>
<%=(OrderBy != null && OrderBy.equals("sif_kupca")) ? "</b>" : ""%>
		</td>
		<td>
<%=(OrderBy != null && OrderBy.equals("kupci.naziv")) ? "<b>" : ""%>
<a href="cenastrlist.jsp?order=<%= java.net.URLEncoder.encode("kupci.naziv","utf-8") %>">Kupec&nbsp;<% if (OrderBy != null && OrderBy.equals("kupci.naziv")) { %><span class="ewTableOrderIndicator"><% if (((String) session.getAttribute("cenastr_OT")).equals("ASC")) { %>(^)<% }else if (((String) session.getAttribute("cenastr_OT")).equals("DESC")) { %>(v)<% } %></span><% } %></a>
<%=(OrderBy != null && OrderBy.equals("kupci.naziv")) ? "</b>" : ""%>
		</td>
		<td>
...
<a href="cenastrlist.jsp?order=<%= java.net.URLEncoder.encode("material_koda","utf-8") %>">Šifra material koda&nbsp;<% if (OrderBy != null && OrderBy.equals("material_koda")) { %><span class="ewTableOrderIndicator"><% if (((String) session.getAttribute("cenastr_OT")).equals("ASC")) { %>(^)<% }else if (((String) session.getAttribute("cenastr_OT")).equals("DESC")) { %>(v)<% } %></span><% } %></a>
<%=(OrderBy != null && OrderBy.equals("material_koda")) ? "</b>" : ""%>
		</td>
		<td>
<%=(OrderBy != null && OrderBy.equals("material_koda")) ? "<b>" : ""%>
<a href="cenastrlist.jsp?order=<%= java.net.URLEncoder.encode("material_koda","utf-8") %>">Material koda&nbsp;<% if (OrderBy != null && OrderBy.equals("material_koda")) { %><span class="ewTableOrderIndicator"><% if (((String) session.getAttribute("cenastr_OT")).equals("ASC")) { %>(^)<% }else if (((String) session.getAttribute("cenastr_OT")).equals("DESC")) { %>(v)<% } %></span><% } %></a>
<%=(OrderBy != null && OrderBy.equals("material_koda")) ? "</b>" : ""%>
		</td>
		<td>
<%=(OrderBy != null && OrderBy.equals("cena")) ? "<b>" : ""%>
<a href="cenastrlist.jsp?order=<%= java.net.URLEncoder.encode("cena","utf-8") %>">Cena&nbsp;<% if (OrderBy != null && OrderBy.equals("cena")) { %><span class="ewTableOrderIndicator"><% if (((String) session.getAttribute("cenastr_OT")).equals("ASC")) { %>(^)<% }else if (((String) session.getAttribute("cenastr_OT")).equals("DESC")) { %>(v)<% } %></span><% } %></a>
<%=(OrderBy != null && OrderBy.equals("cena")) ? "</b>" : ""%>
		</td>
		<td>
<%=(OrderBy != null && OrderBy.equals("veljavnost")) ? "<b>" : ""%>
<a href="cenastrlist.jsp?order=<%= java.net.URLEncoder.encode("veljavnost","UTF-8") %>">Veljavnost&nbsp;<% if (OrderBy != null && OrderBy.equals("veljavnost")) { %><span class="ewTableOrderIndicator"><% if (((String) session.getAttribute("cenastr_OT")).equals("ASC")) { %>(^)<% }else if (((String) session.getAttribute("cenastr_OT")).equals("DESC")) { %>(v)<% } %></span><% } %></a>
<%=(OrderBy != null && OrderBy.equals("veljavnost")) ? "</b>" : ""%>
		</td>
		<td nowrap>
<%=(OrderBy != null && OrderBy.equals("zacetek")) ? "<b>" : ""%>
<a href="cenastrlist.jsp?order=<%= java.net.URLEncoder.encode("zacetek","utf-8") %>">Začetek&nbsp;<% if (OrderBy != null && OrderBy.equals("zacetek")) { %><span class="ewTableOrderIndicator"><% if (((String) session.getAttribute("cenastr_OT")).equals("ASC")) { %>(^)<% }else if (((String) session.getAttribute("cenastr_OT")).equals("DESC")) { %>(v)<% } %></span><% } %></a>
<%=(OrderBy != null && OrderBy.equals("zacetek")) ? "</b>" : ""%>
		</td>
		<td nowrap>
<%=(OrderBy != null && OrderBy.equals("uporabnik")) ? "<b>" : ""%>
<a href="cenastrlist.jsp?order=<%= java.net.URLEncoder.encode("uporabnik","utf-8") %>">Uporabnik&nbsp;<% if (OrderBy != null && OrderBy.equals("uporabnik")) { %><span class="ewTableOrderIndicator"><% if (((String) session.getAttribute("cenastr_OT")).equals("ASC")) { %>(^)<% }else if (((String) session.getAttribute("cenastr_OT")).equals("DESC")) { %>(v)<% } %></span><% } %></a>
<%=(OrderBy != null && OrderBy.equals("uporabnik")) ? "</b>" : ""%>
		</td>
</tr>
<%
...
if (key != null && key.length() > 0) { 
	out.print("cenastrview.jsp?key=" + java.net.URLEncoder.encode(key,"utf-8"));
}else{
...
<td><span class="jspmaker"><a href="<% key =  rs.getString("id"); 
if (key != null && key.length() > 0) { 
	out.print("cenastredit.jsp?key=" + java.net.URLEncoder.encode(key,"utf-8"));
}else{
	out.print("javascript:alert('Invalid Record! Key is null');");
} %>">Spremeni</a></span></td>
<% } %>
...
<td><span class="jspmaker"><a href="<% key =  rs.getString("id"); 
if (key != null && key.length() > 0) { 
	out.print("cenastradd.jsp?key=" + java.net.URLEncoder.encode(key,"utf-8"));
}else{
	out.print("javascript:alert('Invalid Record! Key is null');");
} %>">Kopiraj</a></span></td>
<% } %>
...
<% if ((ewCurSec & ewAllowDelete) == ewAllowDelete) { %>
<% if (recActual > 0) { %>
<p><input type="button" name="btndelete" value="Izbriši izbrane" onClick="this.form.action='cenastrdelete.jsp';this.form.submit();"></p>
<% } %>
<% } %>
</form>
<%
...
<!--first page button-->
	...
	<% }else{ %>
	<td><a href="cenastrlist.jsp?start=1"><img src="images/first.gif" alt="First" width="20" height="15" border="0"></a></td>
	<% } %>
<!--previous page button-->
	<% if (PrevStart == startRec) { %>
	<td><img src="images/prevdisab.gif" alt="Previous" width="20" height="15" border="0"></td>
	<% }else{ %>
	<td><a href="cenastrlist.jsp?start=<%=PrevStart%>"><img src="images/prev.gif" alt="Previous" width="20" height="15" border="0"></a></td>
	<% } %>
<!--current page number-->
...
<!--next page button-->
	...
	<% }else{ %>
	<td><a href="cenastrlist.jsp?start=<%=NextStart%>"><img src="images/next.gif" alt="Next" width="20" height="15" border="0"></a></td>
	<% } %>
<!--last page button-->
	<% if (LastStart == startRec) { %>
	<td><img src="images/lastdisab.gif" alt="Last" width="20" height="15" border="0"></td>
	<% }else{ %>
	<td><a href="cenastrlist.jsp?start=<%=LastStart%>"><img src="images/last.gif" alt="Last" width="20" height="15" border="0"></a></td>
	<% } %>
...
<p>
<% if ((ewCurSec & ewAllowAdd) == ewAllowAdd) { %>
<a href="cenastradd.jsp"><img src="images/addnew.gif" alt="Dodaj" width="20" height="15" border="0"></a>
<% } %>
</p>
<% } %>
</td></tr></table>
