...
/*
		if (session.getAttribute("papirservis1_status_UserLevel")!= null && ((Integer) session.getAttribute("papirservis1_status_UserLevel")).intValue() != -1) { // Non system admin
			strsql = strsql + " AND (`sif_upor` = " + (String) session.getAttribute("papirservis1_status_UserID") + ")";
		}
*/
...
<p><span class="jspmaker">Spremeni : uporabniki<br><br><a href="uporabnikilist.jsp">Nazaj na pregled</a></span></p>
...
<form onSubmit="return EW_checkMyForm(this);"  name="uporabnikiedit" action="uporabnikiedit.jsp" method="post">
<p>
...
<table class="ewTable">
	...
	<tr>
		...
		<input type="checkbox" name="x_tip2"  <%= (Integer.parseInt(x_tip.toString()) & 2) > 0 ? "checked" : "" %>>brisanje&nbsp;
		<input type="checkbox" name="x_tip3"  <%= (Integer.parseInt(x_tip.toString()) & 4) > 0 ? "checked" : "" %>>popravki&nbsp;
		<input type="checkbox" name="x_tip4"  <%= (Integer.parseInt(x_tip.toString()) & 8) > 0 ? "checked" : "" %>>vpogled&nbsp;
		<input type="checkbox" name="x_tip5"  <%= (Integer.parseInt(x_tip.toString()) & 16) > 0 ? "checked" : ""%>>administracia&nbsp;</td>
	</tr>
	<tr>
		<td class="ewTableHeader">meniji&nbsp;</td>
		<td class="ewTableAltRow">
		<input type="checkbox" name="x_meni1"  <%= (Integer.parseInt(x_meni.toString()) & 1) > 0 ? "checked" : "" %>>šifranti&nbsp;
		<input type="checkbox" name="x_meni2"  <%= (Integer.parseInt(x_meni.toString()) & 2) > 0 ? "checked" : "" %>>odvoz&nbsp;
		<input type="checkbox" name="x_meni3"  <%= (Integer.parseInt(x_meni.toString()) & 4) > 0 ? "checked" : "" %>>prodaja&nbsp;
		<input type="checkbox" name="x_meni4"  <%= (Integer.parseInt(x_meni.toString()) & 8) > 0 ? "checked" : "" %>>obračuni&nbsp;
		<input type="checkbox" name="x_meni5"  <%= (Integer.parseInt(x_meni.toString()) & 16) > 0 ? "checked" : "" %>>kalkulacije&nbsp;
		<input type="checkbox" name="x_meni6"  <%= (Integer.parseInt(x_meni.toString()) & 32) > 0 ? "checked" : "" %>>emala&#382nina&nbsp;
		<input type="checkbox" name="x_meni7"  <%= (Integer.parseInt(x_meni.toString()) & 64) > 0 ? "checked" : "" %>>komunale&nbsp;</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="ewTableAltRow">
    		<INPUT type="radio" name="x_narocila" value="0" <%= x_narocila.equals("0")? "checked" : "" %>>Ni dostopa
    		<INPUT type="radio" name="x_narocila" value="1" <%= x_narocila.equals("1")? "checked" : "" %>>Kupec
    		<INPUT type="radio" name="x_narocila" value="2" <%= x_narocila.equals("2")? "checked" : "" %>>Zaposlen
		</td>
	</tr>
	<tr>
