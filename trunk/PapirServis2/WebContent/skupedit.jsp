...
<p><span class="jspmaker">Spremeni : skup<br><br><a href="skuplist.jsp">Nazaj na pregled</a></span></p>
...
<form onSubmit="return EW_checkMyForm(this);"  name="skupedit" action="skupedit.jsp" method="post">
<p>
