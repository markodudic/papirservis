...
public class XLSCreateProdajaServlet extends InitServlet implements Servlet {

	Locale locale = Locale.getDefault();
	private static int rownum = 0;
	private static HSSFWorkbook wb;
	private static HSSFSheet s;
	private static String[] rowNames = {"Št. dobavnice", "Pozicija", "Datum", "Šifra kupca", "Naziv kupca", "Enota", "Koda", "Material", "EWC Koda", "Material", "Regist. st.", "kol_n", "kol_p", "st_bal", "Opomba", "Arso prenos"};
	private static String[] rowTypes = {"S", "N", "S", "S", "S", "S", "S", "S", "S", "S", "S", "N", "N", "N", "S", "S"};
	 ...
	 */
	public XLSCreateProdajaServlet() {
		super();
	}
