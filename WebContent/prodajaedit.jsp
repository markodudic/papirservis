...
String sqlwrk_x_sif_kupca = "SELECT `sif_kupca`, `naziv`, `naslov` FROM `kupci`  where blokada = 0 and prodaja=1 ORDER BY `" + (String)session.getAttribute("prodaja_kupci_show") + "` ASC";
...
String sqlwrk_x_sif_enote = "SELECT DISTINCT `sif_enote`, `naziv`, `lokacija` FROM `enote` order by naziv ASC";
...
<p><span class="jspmaker">Spremeni: prodaja<br><br><a href="prodajalist.jsp">Nazaj na pregled</a></span></p>
...
function updateKoda(EW_this){
	if (sif_ewc[document.prodajaedit.x_koda.selectedIndex-1] != "null")
		document.prodajaedit.x_ewc_ll.value = sif_ewc[document.prodajaedit.x_koda.selectedIndex-1];
	else
		document.prodajaedit.x_ewc_ll.selectedIndex = 0;
}
...
<form onSubmit="return EW_checkMyForm(this);"  name="prodajaedit" action="prodajaedit.jsp" method="post">
<p>
...
<table class="ewTable">
	...
	<tr>
		<td class="ewTableHeader">Številka dobavnica&nbsp;</td>
		<td class="ewTableAltRow"><input type="text" name="x_st_dob_LL" disabled size="30" value="<%= HTMLEncode((String)x_st_dob) %>">&nbsp;</td>
	</tr>
	<tr>
		<td class="ewTableHeader">Pozicija&nbsp;</td>
		<td class="ewTableAltRow"><input type="text" name="x_pozicija_LL" disabled size="30" value="<%= HTMLEncode((String)x_pozicija) %>">&nbsp;</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="ewTableAltRow"><%out.println(x_sif_kupcaList);%><span class="jspmaker"><a href="<%out.print("prodajaedit.jsp?key=" + x_id + "&prikaz_kupca=sif_kupca");%>">šifra</a>&nbsp;<a href="<%out.print("prodajaedit.jsp?key=" + x_id + "&prikaz_kupca=naziv");%>">naziv</a>&nbsp;<a href="<%out.print("prodajaedit.jsp?key=" + x_id + "&prikaz_kupca=naslov");%>">naslov</a>&nbsp;</span>&nbsp;</td>
	</tr>
	<tr>
		<td class="ewTableHeader">Koda&nbsp;</td>
		<td class="ewTableAltRow"><%out.println(x_kodaList);%>
		<a href="<%out.print("prodajaedit.jsp?key=" + x_id + "&prikaz_material=koda");%>">koda</a>&nbsp;<a href="<%out.print("prodajaedit.jsp?key=" + x_id + "&prikaz_material=material");%>">material</a></td></td>
	</tr>
	<tr>
		<td class="ewTableHeader">EWC&nbsp;</td>
		<td class="ewTableAltRow"><%out.println(x_ewcList);%>&nbsp;
		<a href="<%out.print("prodajaedit.jsp?key=" + x_id + "&prikaz_okolje=koda");%>">ewc</a>&nbsp;<a href="<%out.print("prodajaedit.jsp?key=" + x_id + "&prikaz_okolje=material");%>">material</a></td>
	</tr>
	<tr>
