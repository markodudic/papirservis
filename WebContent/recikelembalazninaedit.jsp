...
<p><span class="jspmaker">Popravek v tabeli: recikel embalaznina<br><br><a href="recikelembalazninalist.jsp">Nazaj na pregled</a></span></p>
...
<form onSubmit="return EW_checkMyForm(this);"  name="recikelembalazninaedit" action="recikelembalazninaedit.jsp" method="post">
<p>
