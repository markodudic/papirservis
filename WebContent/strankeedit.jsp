...
<p><span class="jspmaker">Spremeni : stranke<br><br><a href="strankelist.jsp">Nazaj na pregled</a></span></p>
...
if (EW_this.x_sif_str && !EW_checkinteger(EW_this.x_sif_kupca.value)) {
...
<form onSubmit="return EW_checkMyForm(this);"  name="strankeedit" action="strankeedit.jsp" method="post">
<p>
...
<table class="ewTable">
	...
	<tr>
		...
		<td class="ewTableAltRow"><%out.println(x_sif_osList);%>&nbsp;<span class="jspmaker"><a href="<%out.print("strankeedit.jsp?key=" + x_sif_str + "&prikaz_osnovna=sif_os");%>">šifra</a>&nbsp;<a href="<%out.print("strankeedit.jsp?key=" + x_sif_str + "&prikaz_osnovna=osnovna");%>">osnovna</a>&nbsp;</td>
	</tr>
	<tr>
