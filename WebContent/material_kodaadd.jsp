...
try{
	...
	if (rs.getString("okolje_koda") != null){
		...
		// Open record
		String strsql = "SELECT * FROM `material_koda` WHERE 0 = 1";
		rs = stmt.executeQuery(strsql);
		rs.moveToInsertRow();
...
<p><span class="jspmaker">Add to TABLE: material koda<br><br><a href="material_kodalist.jsp">Back to List</a></span></p>
...
<form onSubmit="return EW_checkMyForm(this);"  action="material_kodaadd.jsp" method="post">
<p>
