...
<p><span class="jspmaker">Spremeni : material koda<br><br><a href="material_okoljelist.jsp">Nazaj na pregled</a></span></p>
...
if (EW_this.x_okolje_koda && !EW_hasValue(EW_this.x_okolje_koda, "SELECT" )) {
            if (!EW_onError(EW_this, EW_this.x_okolje_koda, "SELECT", "Napačan vnos - EWC koda"))
                return false; 
        }
return true;
}
...
<form onSubmit="return EW_checkMyForm(this);"  name="material_okoljeedit" action="material_okoljeedit.jsp" method="post">
<p>
...
String sqlwrk_x_material_koda = "SELECT `koda`, `material` FROM `materiali`" + " ORDER BY `" + session.getAttribute("material_okolje_prikaz_material")  + "` ASC";
...
%><a href="<%out.print("material_okoljeedit.jsp?key=" + x_id + "&prikaz_material=koda");%>">koda</a>&nbsp;<a href="<%out.print("material_okoljeedit.jsp?key=" + x_id + "&prikaz_material=material");%>">material</a>
&nbsp;</td>
	</tr>
	<tr>
...
ResultSet rswrk_x_okolje_koda = stmtwrk_x_okolje_koda.executeQuery(sqlwrk_x_okolje_koda);
	...
	while (rswrk_x_okolje_koda.next()) {
		...
		x_okolje_kodaList += ">" + rswrk_x_okolje_koda.getString("koda") + " " + tmpValue_x_okolje_koda + "</option>";
...
%><a href="<%out.print("material_okoljeedit.jsp?key=" + x_id + "&prikaz_okolje=koda");%>">koda</a>&nbsp;<a href="<%out.print("material_okoljeedit.jsp?key=" + x_id + "&prikaz_okolje=material");%>">material</a>
&nbsp;</td>
	</tr>
</table>
<p>
